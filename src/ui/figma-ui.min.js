  ...
  (function() {
    ...
    function e() {
      ...
      for (let o = 0; o < e; o++) {
        ...
        let e = c[o].getElementsByTagName("optgroup");
        if (((r = c[o].selectedIndex), (d = 0), 0 != e.length)) {
          let t;
          t = !!e[0].label;
          for (let o = 0; o < e.length; o++) {
            let i = e[o].getElementsByTagName("option"),
              c = document.createElement("div");
            if (((c.className = s + "__divider"), 1 == t)) {
        ...
        } else for (let e = 0; e < c[o].length; e++) n(c[o].options[e]);
      }
    }
    function t(e, t) {
      let n = c[t];
      ...
      if (((a = document.createElement("ul")), 0 == n.selectedIndex))
      ...
      (o.className = s + "__button"),
        ...
        (a.className = s + "__list"),
        e.appendChild(o),
        e.appendChild(a),
        o.appendChild(r),
        o.appendChild(d),
        r.appendChild(l),
        "overlap" == i.position && (a.style.top = 0),
    ...
    var i,
      ...
      m = function(e) {
        ...
        if ("BUTTON" == t.tagName) {
          ...
          for (let e = 0; e < a; e++) {
            let t = c[e].value;
            t == o && c[e].setAttribute("selected", "selected");
          }
          let r = t.parentNode.parentNode.querySelector("BUTTON"),
            d = r.querySelector("." + s + "__button-label");
          if (
            ((d.textContent = t.textContent),
            r.classList.toggle(s + "__button--active"),
            e.classList.toggle(s + "__list--active"),
            "positionToSelection" == i.position)
          ) {
            let e = -Math.abs(parseInt(t.getAttribute("position")));
